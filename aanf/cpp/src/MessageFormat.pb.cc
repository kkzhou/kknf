...
const ::google::protobuf::Descriptor* MessageFormat_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MessageFormat_reflection_ = NULL;
...
void protobuf_AssignDesc_MessageFormat_2eproto() {
  ...
  MessageFormat_descriptor_ = file->message_type(0);
  static const int MessageFormat_offsets_[5] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, length_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, service_id_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, type_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, version_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, seq_),
  };
  MessageFormat_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      MessageFormat_descriptor_,
      MessageFormat::default_instance_,
      MessageFormat_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, _unknown_fields_),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MessageFormat, _extensions_),
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    MessageFormat_descriptor_, &MessageFormat::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_MessageFormat_2eproto() {
  delete MessageFormat::default_instance_;
  delete MessageFormat_reflection_;
}
...
void protobuf_AddDesc_MessageFormat_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\023MessageFormat.proto\022\014AANF_Message\"i\n\rM"
    "essageFormat\022\016\n\006length\030\001 \002(\007\022\022\n\nservice_"
    "id\030\013 \002(\005\022\014\n\004type\030\014 \002(\005\022\017\n\007version\030\r \002(\005\022"
    "\013\n\003seq\030\016 \002(\003*\010\010d\020\200\200\200\200\002", 142);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "MessageFormat.proto", &protobuf_RegisterTypes);
  MessageFormat::default_instance_ = new MessageFormat();
  MessageFormat::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int MessageFormat::kLengthFieldNumber;
const int MessageFormat::kServiceIdFieldNumber;
const int MessageFormat::kTypeFieldNumber;
const int MessageFormat::kVersionFieldNumber;
const int MessageFormat::kSeqFieldNumber;
#endif  // !_MSC_VER
...
const ::google::protobuf::Descriptor* MessageFormat::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MessageFormat_descriptor_;
}

const MessageFormat& MessageFormat::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MessageFormat_2eproto();  return *default_instance_;
}

MessageFormat* MessageFormat::default_instance_ = NULL;

MessageFormat* MessageFormat::New() const {
...
void MessageFormat::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  ::google::protobuf::uint8* raw_buffer = output->GetDirectBufferForNBytesAndAdvance(_cached_size_);
  if (raw_buffer != NULL) {
    MessageFormat::SerializeWithCachedSizesToArray(raw_buffer);
    return;
  }
...
::google::protobuf::uint8* MessageFormat::SerializeWithCachedSizesToArray(
...
int MessageFormat::ByteSize() const {
  int total_size = 0;
...
void MessageFormat::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const MessageFormat* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const MessageFormat*>(
      &from);
  if (source == NULL) {
...
void MessageFormat::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void MessageFormat::Swap(MessageFormat* other) {
  if (other != this) {
...
::google::protobuf::Metadata MessageFormat::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MessageFormat_descriptor_;
  metadata.reflection = MessageFormat_reflection_;
  return metadata;
}
