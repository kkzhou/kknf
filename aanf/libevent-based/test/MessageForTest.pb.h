...
#ifndef PROTOBUF_MessageForTest_2eproto__INCLUDED
#define PROTOBUF_MessageForTest_2eproto__INCLUDED
...
class UserProfile : public ::google::protobuf::Message {
 ...
 private:
  ...
  friend void  protobuf_AddDesc_MessageForTest_2eproto();
  friend void protobuf_AssignDesc_MessageForTest_2eproto();
  friend void protobuf_ShutdownFile_MessageForTest_2eproto();
...
class CToBFRsp : public ::google::protobuf::Message {
 public:
  ...
  inline ::MessageForTest::CToBFRsp_ErrorCode error() const;
  inline void set_error(::MessageForTest::CToBFRsp_ErrorCode value);
  ...
  inline const ::google::protobuf::RepeatedPtrField< ::MessageForTest::UserProfile >& user_profile() const;
  inline ::google::protobuf::RepeatedPtrField< ::MessageForTest::UserProfile >* mutable_user_profile();
  inline const ::MessageForTest::UserProfile& user_profile(int index) const;
  inline ::MessageForTest::UserProfile* mutable_user_profile(int index);
  inline ::MessageForTest::UserProfile* add_user_profile();
 ...
 private:
  ...
  int error_;
  ::google::protobuf::RepeatedPtrField< ::MessageForTest::UserProfile > user_profile_;
  friend void  protobuf_AddDesc_MessageForTest_2eproto();
  friend void protobuf_AssignDesc_MessageForTest_2eproto();
  friend void protobuf_ShutdownFile_MessageForTest_2eproto();
...
class BFToBB1Rsp : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_error();
  static const int kErrorFieldNumber = 4;
  inline ::MessageForTest::BFToBB1Rsp_ErrorCode error() const;
  inline void set_error(::MessageForTest::BFToBB1Rsp_ErrorCode value);
...
class BFToBB2Rsp : public ::google::protobuf::Message {
 public:
  ...
  inline void clear_error();
  static const int kErrorFieldNumber = 4;
  inline ::MessageForTest::BFToBB2Rsp_ErrorCode error() const;
  inline void set_error(::MessageForTest::BFToBB2Rsp_ErrorCode value);
...
inline ::MessageForTest::CToBFRsp_ErrorCode CToBFRsp::error() const {
  return static_cast< ::MessageForTest::CToBFRsp_ErrorCode >(error_);
}
inline void CToBFRsp::set_error(::MessageForTest::CToBFRsp_ErrorCode value) {
  GOOGLE_DCHECK(::MessageForTest::CToBFRsp_ErrorCode_IsValid(value));
  _set_bit(0);
  error_ = value;
}
...
inline const ::google::protobuf::RepeatedPtrField< ::MessageForTest::UserProfile >&
CToBFRsp::user_profile() const {
  return user_profile_;
}
inline ::google::protobuf::RepeatedPtrField< ::MessageForTest::UserProfile >*
CToBFRsp::mutable_user_profile() {
  return &user_profile_;
}
inline const ::MessageForTest::UserProfile& CToBFRsp::user_profile(int index) const {
  return user_profile_.Get(index);
}
inline ::MessageForTest::UserProfile* CToBFRsp::mutable_user_profile(int index) {
  return user_profile_.Mutable(index);
}
inline ::MessageForTest::UserProfile* CToBFRsp::add_user_profile() {
...
inline ::MessageForTest::BFToBB1Rsp_ErrorCode BFToBB1Rsp::error() const {
  return static_cast< ::MessageForTest::BFToBB1Rsp_ErrorCode >(error_);
}
inline void BFToBB1Rsp::set_error(::MessageForTest::BFToBB1Rsp_ErrorCode value) {
  GOOGLE_DCHECK(::MessageForTest::BFToBB1Rsp_ErrorCode_IsValid(value));
  _set_bit(0);
  error_ = value;
}
...
inline ::MessageForTest::BFToBB2Rsp_ErrorCode BFToBB2Rsp::error() const {
  return static_cast< ::MessageForTest::BFToBB2Rsp_ErrorCode >(error_);
}
inline void BFToBB2Rsp::set_error(::MessageForTest::BFToBB2Rsp_ErrorCode value) {
  GOOGLE_DCHECK(::MessageForTest::BFToBB2Rsp_ErrorCode_IsValid(value));
  _set_bit(0);
  error_ = value;
}
...
inline const ::MessageForTest::UserProfile& BFToBB2Rsp::user_profile(int index) const {
  return user_profile_.Get(index);
}
inline ::MessageForTest::UserProfile* BFToBB2Rsp::mutable_user_profile(int index) {
  return user_profile_.Mutable(index);
}
inline ::MessageForTest::UserProfile* BFToBB2Rsp::add_user_profile() {
  return user_profile_.Add();
}
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MessageForTest::CToBFRsp_ErrorCode>() {
  return ::MessageForTest::CToBFRsp_ErrorCode_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MessageForTest::BFToBB1Rsp_ErrorCode>() {
  return ::MessageForTest::BFToBB1Rsp_ErrorCode_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::MessageForTest::BFToBB2Rsp_ErrorCode>() {
  return ::MessageForTest::BFToBB2Rsp_ErrorCode_descriptor();
}
...
#endif  // PROTOBUF_MessageForTest_2eproto__INCLUDED
